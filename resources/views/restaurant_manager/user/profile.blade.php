@extends('restaurant_manager.user.base')
            ...
            <form method="POST"  action="{{ route('profile.update', $user->id) }}" data-parsley-validate novalidate enctype="multipart/form-data">
                ...
                <div class="col-lg-9 col-xl-9">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  data-parsley-trigger="change" required placeholder="Enter user Name" class="form-control" readonly  value="{{$user->name}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" name="phone" data-parsley-trigger="change" required placeholder="Enter User Phone Number" class="form-control" id="phone"  value="{{$user->phone}}">
                    </div>
                    <div class="form-group">
