...
@section('action-content')
    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <!-- Body -->
            <form method="POST"  action="{{ route('my_restaurant.update', $restaurant->id) }}" data-parsley-validate novalidate enctype="multipart/form-data">
                ...
                <div class="row form-group">
                    ...
                    <div class="row col-md-6">
                      <div class="col-md-6">
                        ...
                        <input type="text" data-parsley-trigger="change" required placeholder="Enter Restaurant Name" class="form-control" value="{{Auth::user()->name}}"  readonly>
                      </div>
                      <div class="col-md-6">
                          <label for="s_name">Is Featured</label>
                          <input type="text" data-parsley-trigger="change" required placeholder="Enter Restaurant Name" class="form-control" value="{{$restaurant->is_featured == 0 ? 'NO' : 'YES'}}"  readonly>
                      </div>
                    </div>
                </div>
