        ...
        <div class="sidebar-inner leftscroll">
            ...
            <ul>
                ...
                <!--    <li class="submenu">
                    ...
                    <li class="submenu">
                        <a href="{{ route('web_notification.index') }}"><i class="fa fa-send bigfonts"></i> <span> Notification </span> </a>
                    </li>

                    <li class="submenu">
                        <a><i class="fa fa-fw fa-tv"></i> <span>  Report </span> <span class="menu-arrow"></span></a>
                            <ul class="list-unstyled">
                                <li><a href="{{route('APP.VIEWS')}}">APP VIEWS </a></li>
                                <li><a href="{{route('RESTAURANT.VIEWS')}}">RESTAURANT VIEWS</a></li>
                                <li><a href="{{route('REDEMPTIONS')}}">REDEMPTIONS VIEWS</a></li>
