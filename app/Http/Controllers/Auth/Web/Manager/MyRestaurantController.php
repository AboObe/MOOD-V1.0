...
class MyRestaurantController extends Controller
{
    ...
    {
        $this->middleware(['auth','RestaurantManager'||'Admin']);
    }
    /**
    ...
    public function index()
    {
        ...
        $restaurantes = DB::table('restaurants')
                    ->where('manager_id','=',$manager_id)->get();
        $count = $restaurantes->count();

        return view('restaurant_manager/restaurant/index',compact('restaurantes','count'));
    }     
    ...
    public function show($id)
    {
        ...
        return view('restaurant_manager/restaurant/show',compact('restaurant','tags','categories','offers','campaigns','photos'));
    } 
     /**
    ...
    { 
        ...
        */
        ...
        return redirect()->intended('my_restaurant');
    }
    /**
    *
    *
